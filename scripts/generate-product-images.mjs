...
const products = [
  ...
  { file: 'nk-theme-fashion.svg',      fn: makeThemeSVG,   args: { slug:'nk-theme-fashion',      name:'NovaKur Fashion Theme',        shortDesc:'Editorial fashion OpenCart 4 theme',        price:39.99, palette:PALETTES.theme, themeStyle:'fashion'  } },
  { file: 'nk-theme-electronics.svg',  fn: makeThemeSVG,   args: { slug:'nk-theme-electronics',  name:'NovaKur Electronics Theme',    shortDesc:'High-tech OpenCart 4 theme for electronics stores', price:44.99, palette:PALETTES.theme, themeStyle:'dark'     } },
  { file: 'nk-theme-furniture.svg',    fn: makeThemeSVG,   args: { slug:'nk-theme-furniture',    name:'NovaKur Furniture Theme',      shortDesc:'Warm premium OpenCart 4 theme for furniture stores', price:44.99, palette:PALETTES.theme, themeStyle:'minimal'  } },
  { file: 'nk-theme-cosmetics.svg',    fn: makeThemeSVG,   args: { slug:'nk-theme-cosmetics',    name:'NovaKur Cosmetics Theme',      shortDesc:'Beauty-focused OpenCart 4 theme with editorial product pages', price:44.99, palette:PALETTES.theme, themeStyle:'fashion'  } },
  { file: 'nk-theme-grocery.svg',      fn: makeThemeSVG,   args: { slug:'nk-theme-grocery',      name:'NovaKur Grocery Theme',        shortDesc:'Dense grocery OpenCart 4 theme with list-view shopping and quantity-first cards', price:59.00, palette:PALETTES.theme, themeStyle:'default'  } },
