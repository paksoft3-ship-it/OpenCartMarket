  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 sm:p-8">
      ...
      <div className="mb-6 grid gap-4 md:grid-cols-3">
        <Kpi label="Toplam Lisans" value="2,941" />
        <Kpi label="Aktif Lisans" value="2,412" />
        <Kpi label="Boşta Lisans" value="529" />
      </div>
          ...
          <tbody>
            {licenses.map((license) => (
              <tr key={license.id} className="border-t border-slate-100 dark:border-slate-800">
                ...
                <td className="px-4 py-3 text-sm text-slate-500">{license.domain ?? "Atanmamış"}</td>
                <td className="px-4 py-3">
                ...
                <td className="px-4 py-3 text-right">
                  <button className="text-sm font-semibold text-primary hover:underline">Yönet</button>
                </td>
              </tr>
            ))}
          </tbody>
