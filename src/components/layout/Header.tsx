    ...
    return (
        <header className="sticky top-0 z-50">
            <div className="bg-gradient-to-r from-primary via-primary to-secondary text-white">
                <Container className="flex items-center justify-between gap-2 py-1.5">
                    <p className="truncate text-xs font-semibold tracking-wide sm:text-sm">OpenCartKur ile tanışmaya hazır mısın?</p>
                    <div className="flex items-center gap-2 text-xs font-semibold sm:text-sm">
                        <Link href="/support" className="inline-flex items-center gap-1 whitespace-nowrap text-white/95 hover:text-white transition-colors">
                            <span className="material-symbols-outlined text-[14px]">event_available</span>
                            Toplantıyı Ayarla
                        </Link>
                        <span className="h-3.5 w-px bg-white/50" aria-hidden="true" />
                        <Link href="/support" className="inline-flex items-center gap-1 whitespace-nowrap text-white/95 hover:text-white transition-colors">
            ...
            <div className="border-b border-slate-200 bg-white/90 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/90">
                <Container className="flex items-center justify-between py-4 whitespace-nowrap">
